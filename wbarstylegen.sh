...
export e_margin=$(( b_height*10/100 ))   # block margin 30% of height
export e_paddin=$(( b_height*5/100 ))    # block padding 10% of height
export g_margin=$(( b_height*15/100 ))   # module margin 14% of height
